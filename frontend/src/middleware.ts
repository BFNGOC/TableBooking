...
const protectedRoutes = ["/reservations", "/settings", "/profile", "/restaurants"];
...
export default auth((req) => {
	 ...
	 * Check permissions
	 */
	const matchedRoute = Object.entries(roleRoutes).find(([prefix]) =>
...
export const config = {
	matcher: [
		...
		"/settings/:path*",
		"/profile/:path*",
		"/restaurants/:slug/reserve/:path*",
		"/restaurants/:slug/booking/:path*",
