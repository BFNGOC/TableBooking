...
function TableCanvasArea({
	...
	useEffect(() => {
		...
		const updateCanvasWidth = () => {
			setCanvasWidth(Math.max(container.clientWidth, 1));
		};
	...
	return (
		<div
			ref={containerRef}
			className="w-full min-w-0 overflow-auto rounded-2xl border border-slate-200 bg-[#fafaf8]"
		>
			<Stage
				width={canvasWidth || CANVAS_WIDTH}
